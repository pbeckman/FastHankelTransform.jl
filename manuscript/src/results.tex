...
Using spherical Bessel function identities, see equations~{10.47.3}
and~{10.49.2} in~\cite{olver2010nist}, one can see that for half-integer $\nu$,
Hankel's expansion~\eqref{eq:asymptotic-expansion} is no longer just an
asymptotic expansion, but an exact formula.
